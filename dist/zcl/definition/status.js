...
(function (Status) {
    ...
    Status[Status["MALFORMED_CMD"] = 128] = "MALFORMED_CMD";
    Status[Status["UNSUP_CLUSTER_CMD"] = 129] = "UNSUP_CLUSTER_CMD";
    Status[Status["UNSUP_GENERAL_CMD"] = 130] = "UNSUP_GENERAL_CMD";
    Status[Status["UNSUP_MANU_CLUSTER_CMD"] = 131] = "UNSUP_MANU_CLUSTER_CMD";
    Status[Status["UNSUP_MANU_GENERAL_CMD"] = 132] = "UNSUP_MANU_GENERAL_CMD";
    Status[Status["INVALID_FIELD"] = 133] = "INVALID_FIELD";
    Status[Status["UNSUP_ATTRIBUTE"] = 134] = "UNSUP_ATTRIBUTE";
